#!/bin/ksh
# This script was generated Sat Jun 28 14:46:35 2025 by:
#
...
#	/home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert.xcn \
#	-assura_run_dir /home/students/Desktop/PRACTICE_DESIGNS/Analog \
#	-assura_run_name Invert -rcxdir \
#	/home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert -xy_coordinates \
#	c,r -type full -temperature 25.0 -tempdir \
#	/home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert/rcx_temp \
...
#	/home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert/extview.tmp \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert
##RCXFS_HIGH=N
##RCXFS_NETS_FILE=
##RCXFS_TYPE=none
...
##TEMPDIR=/home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert
...
export GOALIE2DIR
vdbToRcx /home/students/Desktop/PRACTICE_DESIGNS/Analog Invert -unit meters \
	-- -V1 -H satfile -r \
	/home/students/Desktop/PRACTICE_DESIGNS/Analog/Invert.xcn -df2 -xgl
...
CAP_GROUND=`findCapGround -g Vss -l psubstrate NET`
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -cgnd ${CAP_GROUND},1.0 -sc \
	...
	mt9,mt8,mt7,mt6,mt5,mt4,mt3,mt2,mt1,poly,diff,sti -rPw res.mod \
	...
	-rPw mwires.mod mwires.res,mwires.dev2 -ta \
